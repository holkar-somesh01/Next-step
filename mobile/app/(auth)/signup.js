...
export default function SignupScreen() {
  ...
  // Input styles interpolation helpers
  const getInputStyles = (focusAnim) => {
      ...
      >
        ...
        <View style={[
          ...
          <View style={styles.fieldGroup}>
            ...
            <Animated.View style={[
              styles.inputRow,
              getInputStyles(nameFocusAnim),
            ]}>
              <Ionicons name="person" size={20} color={nameFocused ? '#6366F1' : c.icon} />
              <TextInput
          ...
          <View style={styles.fieldGroup}>
            ...
            <Animated.View style={[
              styles.inputRow,
              getInputStyles(mobileFocusAnim),
            ]}>
              <Ionicons name="call" size={20} color={mobileFocused ? '#6366F1' : c.icon} />
              <TextInput
                style={[styles.input, { color: c.text }]}
